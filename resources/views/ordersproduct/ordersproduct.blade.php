                            ...
                            <div class="card-body">
                                <div class="col-lg-12 margin-tb">
                                    <div class="pull-right">
                                        <a class="btn btn-primary btn-sm" href="{{ route('statusoreder_index') }}">{{__('message.back')}}</a>
                                    </div>
                                </div><br>
                                        ...
                                        <tbody>
                                            @foreach ($ordersproducts as $ordersproduct)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach($ordersproduct->orders_product->products as $drug=>$d)
                                                    ...
                                                    <td>{{$ordersproduct->orders_product->quantity}}</td>
