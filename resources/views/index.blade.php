...
@section('title')
    {{__('messagevalidation.users.index')}}
@endsection
@section('css')
<!--  Owl-carousel css-->
    ...
    <?php use App\Models\orders; ?>
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{__('message.welcome')}}</h2>
                    <p class="mg-b-0">{{__('message.Salesdashboard')}}</p>
                </div>
            </div>
            <div class="main-dashboard-header-right">
                <div>
                    <label class="tx-13">{{__('message.Sales')}}</label>
                    <h5>{{ number_format(orders::where('statusorder_id', 5)->count(), 2) }}</h5>
                </div>
            </div>
        </div>
        <!-- /breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{__('message.Pending')}}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">$ {{ number_format(orders::where('statusorder_id', 1)->sum('total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{orders::where('statusorder_id', 1)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    @php
                                    $ordersproducts = orders::get();
                                    $count_all= $ordersproducts->count();
                                    $count_orders = orders::where('statusorder_id', 1)->count();

                                    if($count_orders == 0){
                                        echo $count_orders = 0;
                                    }
                                    else{
                                        echo $count_orders = $count_orders / $count_all *100;
                                    }
                                    @endphp
                                </span>
                            </span>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{__('message.Dispatched')}}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">$ {{ number_format(orders::where('statusorder_id', 2)->sum('total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{orders::where('statusorder_id', 2)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    ...
                                    $ordersproducts = orders::get();
                                    $count_all= $ordersproducts->count();
                                    $count_orders = orders::where('statusorder_id', 2)->count();
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{__('message.Processed')}}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">$ {{ number_format(orders::where('statusorder_id', 3)->sum('total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{orders::where('statusorder_id', 3)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    ...
                                    $ordersproducts = orders::get();
                                    $count_all= $ordersproducts->count();
                                    $count_orders = orders::where('statusorder_id', 3)->count();
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{__('message.Shipped')}}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">$ {{ number_format(orders::where('statusorder_id', 4)->sum('total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{orders::where('statusorder_id', 4)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    ...
                                    $ordersproducts = orders::get();
                                    $count_all= $ordersproducts->count();
                                    $count_orders = orders::where('statusorder_id', 4)->count();
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-pink-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">{{__('message.Delivered')}}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">$ {{ number_format(orders::where('statusorder_id', 5)->sum('total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{orders::where('statusorder_id', 5)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    ...
                                    $ordersproducts = orders::get();
                                    $count_all= $ordersproducts->count();
                                    $count_orders = orders::where('statusorder_id', 5)->count();
